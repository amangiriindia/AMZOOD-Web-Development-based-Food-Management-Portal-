...
<div class="box-container">
    <?php
      ...
      $sql= "SELECT * FROM tbl_category  WHERE active='Yes'AND featured='Yes' AND Special_food ='Yes' AND veg= $veg ";
      //Execute the Query
...
<div class="image-container" data-aos="fade-left">
  <?php
        ...
        $sql2= "SELECT * FROM tbl_food  WHERE active='Yes'AND featured='Yes' AND popular='Yes' AND veg= $veg ";
        //Execute the Query
 ...
 <!-- dish popular section ends -->
    ...
    <h2 class="text-center">Explore Foods</h2>
        <div class="ccontainer">
            ...
            <?php
                //Create SQl Query to Display category from database
                $sql= "SELECT * FROM tbl_category  WHERE active='Yes'AND featured='Yes' AND veg= $veg ";
                //Execute the Query
                $res=mysqli_query($conn,$sql);
                $count=mysqli_num_rows($res);
                if($count>0)
